...
//		LessonSeven.writeFile( "D:\\cars2.csv", stringBuffer.toString() );
		...
		System.out.println( "output cars2.csv done" );
	}
...
//				int res = String.CASE_INSENSITIVE_ORDER.compare( c1.getManufacturer(), c2.getManufacturer() );
//				if ( res == 0 ) {
//					res = c1.getManufacturer().compareTo( c2.getManufacturer() );
//				}
//				return res;
//			}
//		} );
...
//		// ----------------------
//		StringBuffer stringBuffer = new StringBuffer();
//		System.out.println( String.join( ",", lessonEight.getTitle() ) );
//
//		Boolean sameGroup = true;
//		String lastManufacturer = "";
//		for ( int i = 0; i < lessonEight.getCars().size(); i++ ) {
////			System.out.println( lessonEight.getCars().get( i ) );
//			String currentManufacturer = lessonEight.getCars().get( i ).getManufacturer();
//
//			stringBuffer.append( lessonEight.getCars().get( i ).getManufacturer() );
//			stringBuffer.append( "," );
//			stringBuffer.append( lessonEight.getCars().get( i ).getType() );
...
//			stringBuffer.append( "\r\n" );
//
//			if ( !lastManufacturer.equals( currentManufacturer ) ) {
//				// 輸出小計
//			}
//
//			currentManufacturer = lastManufacturer;
//		}
	}
